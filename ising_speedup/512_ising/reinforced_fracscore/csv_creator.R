...
data_s     <- read.table("../serial_results", header = TRUE,  fill = TRUE,
                         na.string = "") |>
  na.omit()
data_5_c   <- read.table("../5_c_p_results", header = TRUE,  fill = TRUE,
                         na.string = "") |>
  na.omit()
data_10_c  <- read.table("../10_c_p_results", header = TRUE,  fill = TRUE,
                         na.string = "") |>
  na.omit()
data_20_c  <- read.table("../20_c_p_results", header = TRUE,  fill = TRUE,
                         na.string = "") |>
  na.omit()
data_20_h  <- read.table("../20_h_p_results", header = TRUE,  fill = TRUE,
                         na.string = "") |>
  na.omit()
data_100_h <- read.table("../100_p_results", header = TRUE,  fill = TRUE,
                         na.string = "") |>
  na.omit()
data_200_h <- read.table("../200_p_results", header = TRUE,  fill = TRUE,
                         na.string = "") |>
  na.omit()
