...
plot <- plot + ggtitle("200 City Test Problem Serial Results")
...
plot <- plot + ggtitle("105 City Test Problem CDR Heat Map")
...
#  plot <- plot + scale_size_continuous(range=c(0.1, 2))
  ...
  plot <- plot + ggtitle(paste(paste("heat map", proc, sep=" "), "200 city test run", sep= " "))
...
temp_200_matrix <- matrix(c(100, 1000, 1000, 1000), ncol=2,byrow=TRUE)
