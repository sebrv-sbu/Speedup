...
#  plot <- plot + scale_size_continuous(range=c(0.1, 2))
    ...
    plot <- plot + scale_y_reverse(name="E_min/E",breaks=seq(0,max(melted_int_data$bin_E), by=2), expand=c(0,0), labels=lapply(seq(0,max(melted_int_data$bin_E), by=2), transform_bin_E))
